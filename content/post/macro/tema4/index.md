...
![Desequilibrio en el mercado de bienes y dinero](img/DesequilibriosAmbos.png){ width=50% }
...
![Curva de demada agregada](img/CdemandaAgregada.png){ width=50% }
...
![Efecto expulsión](img/efExpusion.png){ width=50% }
